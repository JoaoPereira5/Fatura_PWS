                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-dark" href="router.php?c=user&a=show&id=<?=$user->id ?>"><i class="fa fa-eye" aria-hidden="true"> </i></a>
                                        </td>
                                        <td><a class="btn btn-dark" href="router.php?c=user&a=edit&id=<?=$user->id ?>"><i class="fa fa-pen" aria-hidden="true"> </i></a>
                                        </td>
                                        <?php
