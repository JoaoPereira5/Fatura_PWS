            ...
            <div class="col-9 offset-2">
                <div class="card">
                    <div class="card-header">
                        <p class="card-title">Lista de Utilizadores</p>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><?= $user->nif ?></td>
                                <td><?= $user->role ?></td>
                                <td><a href="router.php?c=user&a=show&id=<?= $user->id ?>"><i class="fa fa-eye"
                                                                                              aria-hidden="true"> </i></a>
                                </td>
                                <td><a href="router.php?c=user&a=edit&id=<?= $user->id ?>"><i class="fa fa-pencil"
                                                                                              aria-hidden="true"> </i></a>
                                </td>
                                <td><a href="router.php?c=user&a=delete&id=<?= $user->id ?>"><i class="fa fa-trash"
                                                                                                aria-hidden="true"> </i></a>
                                </td>
                                <?php } ?>
                            </tr>
