            ...
            <div class="row ml-5">
                <div class="col-lg-5 col-12">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3><?= AdminController::actionTotalFaturasEmitidas() ?></h3>

                            <p>Total Faturas Emitidas</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-5 col-12">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3><?= AdminController::actionTotalFaturasCanceladas() ?></h3>

                            <p>Total Faturas Canceladas</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-5 col-12">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3><?= AdminController::actionTotalUsersAtivos() ?></h3>
                            <p>Total Utilizadores Ativos</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-5 col-12">
                    ...
                    <div class="small-box bg-gradient">
                        <div class="inner">
                            <h3><?= AdminController::actionTotalUsersBanidos() ?></h3>
                            <p>Total Utilizadores Banidos</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-pie-graph"></i>
                        </div>
